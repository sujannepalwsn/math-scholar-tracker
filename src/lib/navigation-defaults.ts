...
export const DEFAULT_NAV_ITEMS = [
  ...
  { name: "Performance", route: "/parent/performance", icon: "TrendingUp", role: "parent", feature_name: "student_report", category: 'Academics', order: 1 },
  { name: "Attendance", route: "/parent/attendance", icon: "CalendarCheck", role: "parent", feature_name: "take_attendance", category: 'Academics', order: 2 },
  { name: "Homework", route: "/parent/homework", icon: "Book", role: "parent", feature_name: "homework_management", category: 'Academics', order: 3 },
  { name: "Tests", route: "/parent/tests", icon: "ClipboardCheck", role: "parent", feature_name: "test_management", category: 'Academics', order: 4 },
  { name: "Exams", route: "/parent/results", icon: "GraduationCap", role: "parent", feature_name: "exams_results", category: 'Academics', order: 5 },
  { name: "Routine", route: "/parent/routine", icon: "Clock", role: "parent", feature_name: "class_routine", category: 'Academics', order: 6 },
  ...
  { name: "About Institution", route: "/parent/about-institution", icon: "Building", role: "parent", feature_name: "about_institution", category: null, order: 12 },
];
