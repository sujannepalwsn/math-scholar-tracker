...
export const DEFAULT_NAV_ITEMS = [
  ...
  { name: "Exams", route: "/parent-results", icon: "GraduationCap", role: "parent", feature_name: "exams_results", category: 'Academics', order: 4 },
  { name: "Routine", route: "/parent/routine", icon: "Clock", role: "parent", feature_name: "class_routine", category: 'Academics', order: 5 },
  { name: "Finance", route: "/parent/fees", icon: "DollarSign", role: "parent", feature_name: "finance", category: 'Administration', order: 6 },
  ...
  { name: "Settings", route: "/parent-settings", icon: "Settings", role: "parent", feature_name: "settings_access", category: 'Administration', order: 8 },
];
