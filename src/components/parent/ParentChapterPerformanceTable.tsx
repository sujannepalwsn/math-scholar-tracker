    ...
    <TableBody>
     {chapterPerformanceData.length === 0 ? (
      ...
      chapterPerformanceData.map((group) => {
       ...
       return (
        <TableRow key={group.lessonPlan.id} className="group transition-all duration-300 hover:bg-white">
         ...
         <TableCell className="px-6 py-4 text-center">
          <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-white shadow-sm group-hover:scale-110 transition-transform" onClick={() => onViewDetails(group)}>
