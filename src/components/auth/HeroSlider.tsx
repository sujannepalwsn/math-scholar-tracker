    ...
    <>
     ...
     <div className="absolute bottom-6 md:bottom-10 right-4 md:right-10 z-30 flex gap-2 md:gap-4">
       <Button
        ...
        className={cn(
         "rounded-full bg-white border-white/10 hover:bg-white text-white h-8 w-8 md:h-12 md:w-12 transition-all ",
      ...
      {slides.map((_, index) => (
       <button
        ...
        className={cn(
         ...
         selectedIndex === index ? "w-6 md:w-10 bg-primary" : "w-1.5 md:w-2 bg-white hover:bg-white"
        )}
