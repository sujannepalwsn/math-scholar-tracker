    ...
    <CardContent className="p-6">
     ...
     <div className="space-y-4">
      {suggestions.map((sug: any) => (
       <div key={sug.id} className="p-4 rounded-2xl border border-border/10 bg-white space-y-3">
        <div className="flex justify-between items-start">
         <div className="space-y-1">
          <div className="flex items-center gap-2">
           <h4 className="font-bold text-lg">{sug.title}</h4>
           {sug.status === 'resolved' ? (
            <Badge className="bg-emerald-100 text-emerald-700 hover:bg-emerald-100 border border-border flex items-center gap-1">
             <CheckCircle2 className="h-3 w-3" /> Resolved
            </Badge>
           ) : (
            <Badge className="bg-amber-100 text-amber-700 hover:bg-amber-100 border border-border flex items-center gap-1">
