 ...
 return (
  <div className="space-y-6">
     ...
     <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
      ...
      <div className="relative">
       <Input
        ...
        className="w-[300px] h-12 rounded-2xl bg-white border border-border shadow-sm font-black text-[10px] uppercase tracking-widest pl-10"
       />
      ...
      <TableBody>
       {parents.length > 0 ? (
        parents.map((parent: any) => (
         <TableRow key={parent.id} className="group transition-all duration-300 hover:bg-white">
          ...
          <TableCell className="px-8 py-5">
           <div className="flex flex-wrap gap-1">
            {parent.parent_students?.map((ps: any, idx: number) => (
             <Badge key={idx} variant="secondary" className="bg-primary/5 text-primary/70 border border-border rounded-lg text-[9px] font-black uppercase">
          ...
          <TableCell className="px-8 py-5">
           {parent.is_active ? (
            <Badge className="bg-emerald-500/10 text-emerald-600 border border-border rounded-lg text-[10px] font-black uppercase">Active</Badge>
           ) : (
            <Badge className="bg-rose-500/10 text-rose-600 border border-border rounded-lg text-[10px] font-black uppercase">Inactive</Badge>
           )}
          </TableCell>
          <TableCell className="px-8 py-5">
          ...
          <TableCell className="px-8 py-5 text-right">
           <div className="flex justify-end gap-2">
            <Button
             variant="ghost"
             size="icon"
             className="h-9 w-9 rounded-xl bg-white shadow-sm text-primary hover:bg-primary/5"
             onClick={() => {
   ...
   <Dialog open={isChangingPassword} onOpenChange={setIsChangingPassword}>
    <DialogContent className="rounded-2xl border border-border shadow-sm bg-white max-w-md">
     <DialogHeader>
     ...
     <div className="py-6 space-y-4">
      <div className="space-y-2">
       ...
       <Input
        ...
        className="h-12 rounded-2xl bg-white border border-border shadow-sm focus-visible:ring-primary/20 font-bold"
       />
      </div>
     </div>
