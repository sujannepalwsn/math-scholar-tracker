 ...
 return (
  <div className="flex flex-col lg:flex-row gap-8 min-h-[600px]">
   ...
   <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
    <Card className="rounded-2xl border border-border shadow-sm bg-blue-50 p-6">
    ...
    <Card className="rounded-2xl border border-border shadow-sm bg-emerald-50 p-6">
    ...
    <Card className="rounded-2xl border border-border shadow-sm bg-amber-50 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
       ...
       <div className="flex items-end">
        <Button
         ...
         className="w-full h-10 rounded-lg font-black uppercase text-[10px] tracking-widest bg-primary text-white shadow-sm hover:scale-[1.02] transition-all"
        >
       ...
       >
         ...
         <>
          <TableCell>
           <div className="flex flex-col gap-1">
             <Badge variant="secondary" className="w-fit text-[9px] font-black tracking-widest bg-indigo-50 text-indigo-700 border border-border">
              TAG: {a.asset_tag || "N/A"}
             </Badge>
        ...
        <TableCell className="text-right px-6">
          <div className="flex justify-end gap-2 opacity-0 group-hover/row:opacity-100 transition-all">
            <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-white shadow-sm"><Settings className="h-3.5 w-3.5 text-slate-400" /></Button>
          </div>
        </TableCell>
       </TableRow>
      ))}
