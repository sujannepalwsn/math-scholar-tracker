             ...
             <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
               ...
               <select
                ...
                className="w-full h-10 rounded-xl bg-white border border-border shadow-sm text-sm px-3"
               >
              ...
              <div className="space-y-1">
               ...
               <Input type="number" value={distForm.amount} onChange={e => setDistForm({...distForm, amount: e.target.value})} className="h-10 rounded-xl bg-white border border-border shadow-sm" placeholder="Qty" />
              </div>
             </div>
