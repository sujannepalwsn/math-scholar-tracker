 ...
 return (
  <div className="space-y-8">
    ...
    {plans?.map((p: any) => {
     ...
     return (
      <Card key={p.id} className={cn(
       "rounded-2xl border border-border shadow-sm bg-white transition-all relative overflow-hidden group",
       ...
       <CardContent className="p-8">
        <div className="flex flex-col gap-1 mb-6">
         <Badge className="w-fit bg-slate-100 text-slate-600 border border-border font-black text-[10px] uppercase tracking-widest py-1 px-3">
          {p.name}
         </Badge>
        ...
        <div className="space-y-4 mb-8">
         ...
         <div className="pt-4 border-t border-slate-100">
          <Dialog>
           ...
           <DialogContent className="max-w-2xl rounded-2xl border border-border shadow-sm bg-white ">
            <DialogHeader>
              ...
              {SYSTEM_MODULES.map((mod) => {
               ...
               return (
                <div key={mod.id} className={cn(
                 ...
                 isIncluded ? "bg-white shadow-sm border-emerald-100" : "bg-slate-50/50 border-slate-100 opacity-50 grayscale"
                )}>
                 <div className="flex items-center justify-between mb-2">
                  ...
                  {isIncluded ? (
                   <Badge className="bg-emerald-50 text-emerald-600 border border-border text-[9px] font-black uppercase">Standard Feature</Badge>
                  ) : (
   ...
   {currentSub && currentSub.status === 'Active' && (
    <Card className="rounded-2xl border border-border shadow-sm bg-primary/5 overflow-hidden">
     <CardContent className="p-8 flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="h-16 w-16 rounded-full bg-white flex items-center justify-center shadow-sm shrink-0">
   ...
   {currentSub && (currentSub.status === 'Pending' || currentSub.status === 'Rejected') && (
    <Card className="rounded-2xl border border-border shadow-sm bg-slate-50 overflow-hidden">
      <CardContent className="p-8 flex items-center justify-between">
       <div className="space-y-1">
         ...
         <h4 className="text-lg font-black text-slate-800">
          ...
          {currentSub.status === 'Pending' && <Badge className="ml-2 bg-amber-100 text-amber-600 border border-border uppercase text-[9px] font-black">Waiting for Approval</Badge>}
          {currentSub.status === 'Rejected' && <Badge className="ml-2 bg-rose-100 text-rose-600 border border-border uppercase text-[9px] font-black">Request Declined</Badge>}
         </h4>
      ...
      <div className="space-y-6 pt-4">
        <div className="p-6 rounded-2xl bg-primary/5 border border-primary/10">
         <div className="flex justify-between items-center mb-4">
           ...
           <Badge className="bg-primary text-white border border-border uppercase font-black text-[10px]">{requestPlan.name}</Badge>
         </div>
        ...
        <TableRow key={inv.id}>
         ...
         <TableCell>
          <Badge className={cn(
           ...
           inv.status === 'Paid' ? "bg-emerald-50 text-emerald-600 border border-border" : "bg-rose-50 text-rose-600 border border-border"
          )}>
           {inv.status}
          </Badge>
         </TableCell>
