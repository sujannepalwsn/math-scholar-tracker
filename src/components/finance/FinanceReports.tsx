 ...
 return (
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
   <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <Card className="border border-border shadow-sm rounded-2xl bg-white border border-white/20 overflow-hidden">
   ...
   <Card className="border border-border shadow-sm rounded-2xl bg-white border border-white/20 p-8">
