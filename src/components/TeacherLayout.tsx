...
const navItems: Array<{
  ...
  { to: "/teacher/exams", label: "Exam Management", icon: GraduationCap, role: 'teacher' as const, featureName: 'test_management', category: 'Academics' },
  { to: "/teacher/results-dashboard", label: "Results Analytics", icon: TrendingUp, role: 'teacher' as const, featureName: 'test_management', category: 'Academics' },
  { to: "/teacher/marksheet", label: "Marksheets", icon: FileText, role: 'teacher' as const, featureName: 'test_management', category: 'Academics' },
