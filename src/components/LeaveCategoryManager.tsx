  ...
  <div className="space-y-6">
   <div className="flex flex-col gap-4 p-4 rounded-2xl bg-primary/5 border border-primary/10">
    ...
    <Button
     ...
     className="w-full rounded-xl h-12 font-black text-xs tracking-widest bg-primary shadow-sm"
    >
   ...
   <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
    {isLoading ? (
     ...
     categories.map((cat) => (
      <div key={cat.id} className="flex flex-col gap-3 p-4 rounded-2xl bg-card border border-muted-foreground/10 group shadow-sm hover:shadow-sm transition-all">
       ...
       <div className="flex gap-2 pt-2 border-t border-muted-foreground/5">
        ...
        <Button
         variant="outline"
         size="sm"
         className="h-8 text-[10px] font-bold rounded-lg px-3 bg-white"
