 ...
 return (
  <div className="space-y-6">
   ...
   <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
     <Card className="rounded-2xl border shadow-sm bg-blue-500/5">
     ...
     <Card className="rounded-2xl border shadow-sm bg-emerald-500/5">
      <CardContent className="p-6 flex items-center gap-4">
     ...
     <Card className="rounded-2xl border shadow-sm bg-indigo-500/5">
      <CardContent className="p-6 flex items-center gap-4">
     ...
     <Card className="rounded-2xl border shadow-sm bg-slate-500/5">
      <CardContent className="p-6 flex items-center gap-4">
