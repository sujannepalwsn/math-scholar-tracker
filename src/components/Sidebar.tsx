...
export default function Sidebar({
 ...
 const desktopSidebar = (
  <TooltipProvider>
   ...
   >
    <div className="flex flex-col h-auto pt-4 pb-2 px-4 border-b border-border space-y-4">
     ...
     {isDemoSession && !isCollapsed && (
       <div className="p-1.5 rounded-xl bg-slate-50 border border-border flex gap-1">
        {[
         ...
         <button
          ...
          className={cn(
           ...
           user.role === item.r ? "bg-primary text-white shadow-sm" : "text-slate-500 hover:text-slate-700 hover:bg-white"
          )}
         >
          {item.l}
         </button>
 ...
 const mobileSidebar = (
  <div
   className={cn(
    ...
    isMobileOpen ? "bg-foreground/40 " : "pointer-events-none opacity-0"
   )}
   onClick={handleMobileClose}
  >
