 ...
 return (
  <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
     {availablePresets.map((preset) => (
      ...
      >
       ...
       {userPreferences.theme === preset.name && (
        <div className="absolute -top-2 -right-2 h-6 w-6 rounded-full bg-primary flex items-center justify-center shadow-sm animate-in zoom-in duration-300">
   ...
   <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
    <Card className="border border-border shadow-sm rounded-2xl bg-white border border-border/20 overflow-hidden group hover:shadow-sm transition-all">
