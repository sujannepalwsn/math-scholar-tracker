...
export default function DashboardHeader() {
 ...
 if (isCenterLoading) {
  return (
   <div className="w-full h-32 flex items-center justify-center bg-card rounded-2xl animate-pulse">
 ...
 if (headerConfig && headerConfig.elements && headerConfig.elements.length > 0) {
  ...
  return (
   <div
    ref={containerRef}
    className="w-full mb-8 relative overflow-hidden rounded-2xl md:rounded-[3rem] shadow-sm transition-all duration-500 bg-white border border-border group/header"
    style={{
 ...
 return (
  <Card
   className="border border-border shadow-sm overflow-hidden rounded-2xl md:rounded-[3rem] bg-white mb-8 relative group/header"
  ...
  >
   <CardContent className="py-12 px-5 md:p-12 relative z-10 space-y-8 h-full flex flex-col justify-center text-center">
     <div className="flex flex-col items-center gap-6">
       <div className="h-28 w-28 md:h-36 md:w-36 rounded-full overflow-hidden flex items-center justify-center border-4 border-white/50 shadow-sm bg-white">
