 ...
 if (isTeacher) {
  return (
   <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in duration-1000">
    ...
    <Card className="border border-border shadow-sm rounded-2xl bg-white overflow-hidden">
     ...
     <CardContent className="p-8 space-y-8">
      <div className="grid grid-cols-2 gap-6">
       <div className="space-y-1 text-center p-4 rounded-2xl bg-muted/30 border border-muted-foreground/5">
      ...
      <div className="space-y-4">
       <Button
        className="w-full h-20 text-xl font-black rounded-[1.5rem] shadow-sm bg-gradient-to-r from-emerald-500 to-teal-600 hover:scale-[1.02] transition-all disabled:opacity-50"
       ...
       <Button
        variant="outline"
        className="w-full h-20 text-xl font-black rounded-[1.5rem] border-2 shadow-sm hover:bg-rose-50 hover:border-rose-200 hover:text-rose-600 transition-all disabled:opacity-50"
 ...
 return (
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
   <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
    ...
    <div className="flex items-center gap-3 bg-white p-1.5 rounded-2xl shadow-sm border border-slate-100 group transition-all hover:shadow-sm">
   ...
   <div className="relative group">
    ...
    <Card className="relative border border-border shadow-sm p-6 overflow-hidden bg-white border border-white/30 rounded-2xl">
      ...
      <div className="flex-1 min-w-[200px] space-y-2">
       ...
       <Popover>
        <PopoverTrigger asChild>
         <Button variant="outline" className={cn("w-full h-11 justify-start text-left font-normal bg-white border-muted-foreground/10 focus:ring-primary/20 rounded-xl", !selectedDate && "text-muted-foreground")}>
          <CalendarIconLucide className="mr-2 h-4 w-4" />
          {selectedDate ? safeFormatDate(selectedDate, "PPP") : "Pick a date"}
         </Button>
        </PopoverTrigger>
        <PopoverContent className="w-auto p-0 rounded-2xl border border-border shadow-sm" align="start">
     ...
     {teachersLoading || attendanceLoading ? (
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <TableRow key={teacher.id} className="group border-muted/5 hover:bg-primary/5 transition-colors">
             ...
             <TableCell>
              <Select
               ...
               disabled={!canEdit}
              >
               <SelectTrigger className="w-[120px] h-9 bg-white shadow-sm border border-border focus:ring-primary/20 rounded-xl font-bold text-xs">
                <SelectValue />
               </SelectTrigger>
               <SelectContent className=" bg-white border-muted-foreground/10 rounded-xl font-bold">
             ...
             <TableCell>
              <Input
               ...
               className="h-9 w-32 bg-white border border-border shadow-sm rounded-xl text-xs font-bold"
              />
             </TableCell>
             <TableCell>
              <Input
             ...
             <TableCell className="pr-6">
              <Input
               ...
               disabled={!canEdit}
               className="h-9 bg-white border border-border shadow-sm rounded-xl text-xs font-medium"
              />
             </TableCell>
            </TableRow>
           );
       ...
       <div className="p-6 border-t border-muted/10">
        ...
        <Button
         type="submit"
         className="w-full h-14 text-lg font-black shadow-sm rounded-2xl bg-gradient-to-r from-primary to-violet-600 hover:scale-[1.01] transition-all duration-300"
   ...
   <Card className="border border-border shadow-sm overflow-hidden rounded-2xl bg-white border border-border/20 h-fit mt-12">
    <CardHeader className="bg-gradient-to-r from-primary to-violet-600 text-primary-foreground py-6 shadow-sm">
     <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
      ...
      <div className="flex gap-3">
       <Button variant="outline" size="sm" onClick={exportReportToCSV} className="rounded-xl border-border/20 bg-white hover:bg-white text-white font-bold h-10 px-4">
        <Download className="mr-2 h-4 w-4" /> CSV EXPORT
       </Button>
       <Button variant="outline" size="sm" onClick={handlePrintReport} className="rounded-xl border-border/20 bg-white hover:bg-white text-white font-bold h-10 px-4">
    ...
    <CardContent className="p-6">
     <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
      <div className="space-y-1">
       ...
       <Input
        ...
        className="w-[200px] h-11 bg-white border-muted-foreground/10 focus:ring-primary/20 rounded-xl font-bold"
       />
      </div>
     ...
     {teachersLoading || logsLoading ? (
      ...
      <div className="text-center py-12 bg-muted/5 rounded-2xl border border-dashed border-muted/20">
       <p className="text-muted-foreground font-medium italic">No performance data available for this period.</p>
      </div>
     ) : (
      <div id="teacher-attendance-report-printable" className="overflow-x-auto rounded-2xl border border-muted/10 bg-white">
       <div className="overflow-x-auto">
 <Table>
        <TableHeader>
        ...
        <TableBody>
         {reportData.map(summary => (
          <TableRow key={summary.id} className="group border-muted/5 hover:bg-white transition-colors">
           <TableCell className="pl-6 py-4">
           ...
           <TableCell className="text-right pr-6">
            <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-white shadow-sm text-primary hover:bg-primary/10" onClick={() => handleTeacherClick({ id: summary.id, name: summary.name } as Teacher)}>
