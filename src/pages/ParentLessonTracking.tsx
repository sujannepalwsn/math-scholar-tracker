       ...
       <Table>
        ...
        <tbody>
         {lessonRecords.map((lr: any) => (
          <TableRow key={lr.id} className="group transition-all duration-300 hover:bg-white">
           <TableCell className="px-6 py-4">
            <Badge variant="secondary" className="bg-primary/5 text-primary/70 border border-border rounded-lg text-[9px] font-black uppercase tracking-tighter">
           ...
           <TableCell className="px-6 py-4 text-right">
            {lr.lesson_plans?.lesson_file_url ? (
             <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-white shadow-sm" asChild>
