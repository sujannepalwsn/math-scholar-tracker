   ...
   <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
    ...
    <div className="flex flex-wrap gap-3">
     <Select value={gradeFilter} onValueChange={setGradeFilter}>
      <SelectTrigger className="w-[140px] h-11 bg-white border-muted-foreground/10 focus:ring-primary/20 rounded-xl">
          ...
          <TableRow key={issue.id} className="group border-muted/5 hover:bg-primary/5 transition-colors">
           ...
           <TableCell>
            <div className="flex gap-2">
             ...
             <Badge
              className={cn(
               "rounded-lg px-2 py-0.5 text-[10px] font-black uppercase border border-border tracking-wider",
           ...
           <TableCell className="text-center">
            <Badge className={cn(
             "rounded-xl px-3 py-1 font-bold text-[10px] uppercase border border-border shadow-sm",
           ...
           <TableCell className="text-right pr-6">
            <div className="flex justify-end gap-2">
             {hasActionPermission(user, 'discipline_issues', 'edit') && (
              <>
               <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-white shadow-sm text-primary hover:bg-primary/10" onClick={() => handleEditClick(issue)}>
                <Edit className="h-4 w-4" />
               </Button>
               <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-white shadow-sm text-destructive hover:bg-destructive/10" onClick={() => deleteIssueMutation.mutate(issue.id)}>
