  ...
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
   ...
   <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
    {[
     ...
     <Card key={s.title} className="border border-border shadow-sm rounded-2xl bg-white border border-border/20 group hover:-translate-y-1 transition-all duration-500">
      ...
      <Table>
       ...
       <TableBody>
        {teacherStats.length === 0 ? (
         ...
         <TableRow key={t.id} className="group transition-all duration-300 hover:bg-white">
