  ...
  <div className="min-h-screen bg-background p-4 md:p-8 space-y-8 pb-24 md:pb-8 page-enter animate-in fade-in duration-1000">
   ...
   <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
    ...
    <div className="flex flex-wrap gap-4 items-center">
     <Button
      ...
      className="rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-black uppercase text-[10px] tracking-widest h-12 px-6 shadow-sm transition-all hover:scale-105"
     >
     ...
     {linkedStudents.length > 1 && (
      <Select value={selectedStudentId || ''} onValueChange={setSelectedStudentId}>
       <SelectTrigger className="w-56 bg-white border border-border/40 shadow-sm rounded-[1.25rem] font-black uppercase text-[10px] tracking-widest h-12 px-6">
        <SelectValue placeholder="Select Scholar" />
       </SelectTrigger>
       <SelectContent className="rounded-2xl border border-border shadow-sm bg-white">
   ...
   <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div className="space-y-6">
     <div className="p-8 rounded-2xl bg-indigo-600 shadow-indigo-200 shadow-2xl text-white relative overflow-hidden group">
      ...
      <div className="relative z-10 space-y-4">
       ...
       <Button
        ...
        className="bg-white text-indigo-600 hover:bg-white rounded-xl font-black uppercase text-[10px] tracking-widest px-8"
       >
   ...
   <div className="flex justify-center pt-8 border-t border-slate-100">
    <Button
     variant="outline"
     className="rounded-2xl border-2 font-black uppercase tracking-widest text-[10px] h-12 px-8 shadow-sm bg-white hover:bg-slate-50"
