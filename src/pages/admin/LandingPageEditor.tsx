    ...
    <TabsContent value="features" className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
       {formData.features.map((feature: any, idx: number) => (
        <Card key={idx} className="border border-border shadow-sm rounded-2xl group overflow-hidden relative">
         <Button
          variant="ghost"
          size="icon"
         ...
         <CardContent className="pt-8 space-y-4">
          <div className="grid grid-cols-[80px_1fr] gap-6">
            <div className="space-y-2">
             ...
             >
              <SelectTrigger className="h-14 rounded-xl border border-border bg-muted/50 font-bold">
               <SelectValue />
              </SelectTrigger>
            ...
            <div className="space-y-2">
             ...
             <Input
              ...
              className="h-14 rounded-xl font-bold bg-muted/50 border border-border"
             />
            </div>
          </div>
          <div className="space-y-2">
            ...
            <Textarea
             ...
             className="rounded-xl font-medium bg-muted/50 border border-border resize-none min-h-[80px]"
            />
          </div>
         </CardContent>
        </Card>
      ...
      <div className="space-y-6">
       ...
       <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {formData.footer_links.map((column: any, colIdx: number) => (
         <Card key={colIdx} className="border border-border shadow-sm rounded-2xl bg-muted/20 relative group">
          <Button
           variant="ghost"
           size="icon"
           onClick={() => {
          ...
          <CardHeader>
           <Input
            ...
            className="font-black uppercase tracking-widest border border-border bg-transparent focus-visible:ring-0 p-0 h-auto text-sm"
           />
          </CardHeader>
          <CardContent className="space-y-4">
           ...
           <Button
            ...
            className="w-full h-9 rounded-lg text-xs font-bold border border-dashed hover:bg-white"
           >
