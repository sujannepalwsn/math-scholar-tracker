...
const Settings = () => (
 <div className="space-y-8 animate-in fade-in duration-1000">
  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
   ...
   <Badge className="bg-primary/10 text-primary border border-border text-[10px] font-black px-3 py-1 uppercase tracking-widest">v2.4.0-Stable</Badge>
  </div>

  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    <Card className="md:col-span-2 border border-border shadow-sm rounded-2xl bg-white border border-border/20 overflow-hidden">
    ...
    <Card className="md:col-span-2 border border-border shadow-sm rounded-2xl bg-white border border-border/20 overflow-hidden">
     ...
     <CardContent className="p-8">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
       ...
       <Button asChild className="rounded-2xl h-12 px-8 font-black uppercase text-xs tracking-widest shadow-sm">
     ...
     <CardContent className="p-12">
      <div className="flex flex-col items-center justify-center text-center space-y-6">
       <div className="relative">
        ...
        <div className="relative p-6 bg-white shadow-sm rounded-2xl text-primary">
    ...
    <div className="space-y-6">
     <Card className="border border-border shadow-sm rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 text-white overflow-hidden">
      <CardContent className="p-6 space-y-6">
        <div className="flex items-center justify-between">
         <div className="p-2 rounded-xl bg-white ">
          <Shield className="h-6 w-6" />
         </div>
         <Badge className="bg-emerald-500/20 text-emerald-400 border border-border text-[9px] font-black uppercase tracking-widest px-2">Encrypted</Badge>
        </div>
        <div className="space-y-1">
