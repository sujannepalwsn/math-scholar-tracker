     ...
     <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="space-y-2">
       ...
       <input
        ...
        className="flex h-11 w-full rounded-xl border border-border/20 bg-white px-4 py-2 text-sm ring-offset-background transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 shadow-sm hover:border-primary/30"
       />
      </div>
      <div className="space-y-2">
        ...
        return (
         <TooltipProvider key={dateStr}>
          <Tooltip>
           ...
           {remarks && (
            <TooltipContent className="bg-white border-muted-foreground/10 rounded-xl p-3 shadow-sm max-w-xs">
     ...
     <CardContent className="p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
       {stats.map((stat) => (
        <div
         key={stat.studentId}
         className="rounded-2xl border border-border/40 bg-white p-6 shadow-sm group relative hover:shadow-sm transition-all duration-300 "
        >
         <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-right bg-white p-2.5 rounded-2xl shadow-sm min-w-[90px] border border-primary/5">
         ...
         <div className="space-y-4">
          ...
          <div className="flex gap-2">
           <Badge variant="secondary" className="bg-green-500/10 text-green-600 border border-border rounded-lg px-2 py-0.5 text-[9px] font-bold">
            {stat.presentDays} Present
           </Badge>
           <Badge variant="secondary" className="bg-red-500/10 text-red-600 border border-border rounded-lg px-2 py-0.5 text-[9px] font-bold">
