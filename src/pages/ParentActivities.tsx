     ...
     {isLoading ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-8">
       {activities.map((sa: any) => {
        ...
        return (
         <Card key={sa.id} className="overflow-hidden border border-border/40 bg-white shadow-sm hover:shadow-sm hover:-translate-y-2 transition-all duration-500 rounded-2xl group">
          <div className="relative aspect-video overflow-hidden">
           ...
           <div className="absolute top-4 left-4">
             <Badge className="bg-white text-foreground border border-border text-[9px] font-black uppercase tracking-widest px-2.5 py-1 shadow-sm">
          ...
          <CardContent className="p-6 space-y-4">
           ...
           <div className="flex items-center justify-between pt-4 border-t border-slate-100">
            ...
            <div className="flex gap-2">
             {activity.photo_url && (
              <Button variant="ghost" size="icon" className="h-9 w-9 rounded-xl bg-white shadow-sm hover:bg-primary/5 hover:text-primary transition-all" asChild>
