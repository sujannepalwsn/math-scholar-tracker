   ...
   <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
    <div className="space-y-2">
     <div className="flex items-center gap-3">
      <div className="p-2.5 rounded-2xl bg-primary-light border border-primary/10">
    ...
    <div className="flex flex-wrap gap-3 items-center">
     <Select value={gradeFilter} onValueChange={setGradeFilter}>
      <SelectTrigger className="w-[140px] h-10 bg-slate-50 border-border focus:ring-primary/20 rounded-xl">
     ...
     <Dialog open={isDialogOpen} onOpenChange={(open) => { setIsDialogOpen(open); if (!open) resetForm(); }}>
      {hasActionPermission(user, 'homework_management', 'edit') && (
       <DialogTrigger asChild>
        <Button className="rounded-xl shadow-sm bg-primary hover:bg-primary/90 text-white">
           ...
           <TableCell className="text-right">
            <div className="flex justify-end gap-2">
             <Button
              variant="ghost"
              size="sm"
              className="h-8 rounded-xl bg-white shadow-sm text-primary hover:text-primary hover:bg-primary/10"
             ...
             {hasActionPermission(user, 'homework_management', 'edit') && (
              <>
               <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 rounded-xl bg-white shadow-sm text-primary hover:text-primary hover:bg-primary/10"
               ...
               <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 rounded-xl bg-white shadow-sm text-destructive hover:text-destructive hover:bg-destructive/10"
