 ...
 <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
  ...
  <CardContent className="p-0">
   ...
   <div className="overflow-x-auto">
    ...
    <TableBody>
     ...
     return (
      <TableRow key={attendee.id} className="group transition-all duration-300 hover:bg-white">
      ...
      <TableCell className="px-6 py-4">
       <Badge variant="outline" className={cn("rounded-lg border border-border text-[9px] font-black uppercase tracking-tighter", getStatusStyles(meeting.status))}>
       {meeting.status}
       </Badge>
      </TableCell>
      <TableCell className="px-6 py-4">
       <Badge variant="outline" className={cn("rounded-lg border border-border text-[9px] font-black uppercase tracking-tighter", getAttendanceStyles(attendee.attendance_status))}>
       {attendee.attendance_status || 'pending'}
       </Badge>
      </TableCell>
      <TableCell className="px-6 py-4 text-right">
       {conclusion ? (
       <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-white shadow-sm" onClick={() => handleViewConclusion(conclusion)}>
  ...
  <DialogContent className="w-[95vw] sm:max-w-2xl rounded-2xl border border-border shadow-sm bg-white ">
   ...
   <div className="space-y-6 pt-4">
    ...
    <div className="p-6 rounded-2xl bg-primary/5/50 border border-primary/10/50">
