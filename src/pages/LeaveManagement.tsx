  ...
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
   <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
    ...
    <Button
     ...
     className="rounded-2xl h-12 px-6 font-bold shadow-sm gap-2 border-2"
    >
    ...
    {(user?.role === UserRole.TEACHER || user?.role === UserRole.PARENT) && (
     <Button
      ...
      className="rounded-2xl h-12 px-6 font-bold shadow-sm gap-2 bg-gradient-to-r from-primary to-violet-600"
     >
   ...
   <div className="flex flex-wrap gap-4 items-center">
    <div className="relative flex-1 min-w-[300px]">
     ...
     <Input
      ...
      className="pl-10 h-11 rounded-xl bg-white border-muted-foreground/10"
     />
    </div>
    <div className="flex items-center gap-2 bg-white p-1 rounded-xl border border-muted-foreground/10">
     <Button
         ...
         <TableRow key={app.id} className="border-muted/5 group hover:bg-primary/5 transition-colors">
          ...
          <TableCell className="text-right pr-6">
           <Button
            variant="ghost"
            size="icon"
            className="rounded-xl h-9 w-9 bg-white shadow-sm group-hover:bg-primary group-hover:text-white transition-all"
            onClick={() => {
             setSelectedApp(app);
        ...
        <div className="flex gap-3">
         {hasActionPermission(user, 'leave_management', 'approve') ? (
          <>
           ...
           <Button
            className="rounded-xl font-black uppercase text-[10px] tracking-widest bg-gradient-to-r from-green-600 to-emerald-600 shadow-sm"
