...
const FeaturesPage = () => {
 return (
  <div className="min-h-screen bg-slate-950 text-white selection:bg-primary/20 selection:text-primary">
   ...
   {/* Header */}
   <header className="fixed top-0 w-full z-[100] px-4 md:px-6 py-4 flex items-center justify-between border-b border-white/5 bg-slate-950/80 transition-all">
   ...
   <main className="pt-40 pb-20 container mx-auto px-4">
    ...
    <FeatureSuite
     ...
     mockup={
      <div className="glass-surface rounded-2xl border border-white/10 p-6 bg-slate-900/40 aspect-video flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-4 flex-1">
         <div className="bg-white rounded-2xl border border-white/5 p-4 flex flex-col justify-between">
         ...
         <div className="col-span-2 bg-white rounded-2xl border border-white/5 p-4">
    ...
    <FeatureSuite
     ...
     reverse={true}
     mockup={
      <div className="glass-surface rounded-2xl border border-white/10 p-6 bg-slate-900/40 aspect-video flex flex-col gap-6">
    ...
    <FeatureSuite
     ...
     mockup={
      <div className="bg-white rounded-2xl border border-border p-8 shadow-xl aspect-video overflow-hidden relative">
        <div className="absolute bottom-0 right-0 w-32 h-32 bg-purple-500/5 blur-3xl" />
        <div className="grid grid-cols-4 gap-4 h-full">
         <div className="col-span-1 space-y-3">
           {[1, 2, 3, 4].map(i => <div key={i} className="h-10 bg-slate-50 rounded-xl border border-border" />)}
         </div>
         <div className="col-span-3 bg-slate-50 rounded-2xl border border-border p-6 relative overflow-hidden">
           ...
           <div className="space-y-4">
            {[1, 2, 3].map(i => (
             <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-white border border-border shadow-sm">
    ...
    <FeatureSuite
     ...
     mockup={
      <div className="relative h-full flex items-center justify-center py-10">
        <div className="w-56 h-[420px] rounded-2xl bg-slate-950 border-[8px] border-slate-900 shadow-2xl relative overflow-hidden">
         <div className="absolute top-0 left-1/2 -translate-x-1/2 w-20 h-6 bg-slate-900 rounded-b-2xl z-20" />
         <div className="p-4 pt-10 space-y-4">
           <div className="p-3 rounded-2xl bg-primary-light border border-primary/10 text-[10px] space-y-1 shadow-sm">
            <p className="font-black text-primary uppercase">New Message</p>
            <p className="text-slate-600">Your child arrived at school at 8:45 AM.</p>
           </div>
           <div className="p-3 rounded-2xl bg-white border border-border text-[10px] space-y-1 shadow-sm">
            <p className="font-black text-slate-900 uppercase">Fee Reminder</p>
            <p className="text-slate-500">Monthly tuition for June is now due.</p>
           </div>
           <div className="p-3 rounded-2xl bg-white border border-white/10 text-[10px] space-y-1 opacity-50">
            <div className="h-2 w-12 bg-white rounded-full mb-1" />
            <div className="h-2 w-full bg-white rounded-full" />
           </div>
         </div>
         <div className="absolute bottom-6 left-4 right-4 h-10 bg-slate-900 rounded-2xl flex items-center px-4">
           <div className="h-1 w-full bg-white rounded-full" />
         </div>
        </div>
        <div className="absolute -right-4 top-20 w-48 h-48 bg-amber-500/5 rounded-2xl blur-3xl -z-10" />
      </div>
     }
    />
    ...
    <section className="mt-40 text-center">
      <h2 className="text-5xl md:text-7xl font-black tracking-tight mb-12 uppercase leading-[1.1] text-slate-950">Ready to see it <br />in action?</h2>
      <div className="flex flex-wrap gap-6 justify-center">
       <Button asChild size="lg" className="h-20 px-16 rounded-2xl text-2xl font-black bg-primary hover:bg-primary/90 text-white shadow-xl shadow-primary/20">
        <Link to="/onboarding">Start Free Trial</Link>
       </Button>
       <Button asChild variant="outline" size="lg" className="h-20 px-16 rounded-2xl text-2xl font-black border-border hover:bg-slate-50 text-slate-900">
