 ...
 <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
  ...
  <div className="w-full md:w-72">
   ...
   <input
    ...
    className="w-full h-11 pl-10 pr-4 bg-white border border-slate-200 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-primary/20 focus:border-primary/40 transition-all shadow-sm"
    value={searchQuery}
  ...
  <Card className="lg:col-span-4 rounded-2xl border border-border shadow-sm bg-white overflow-hidden h-fit border border-white/20">
  ...
  <div className="lg:col-span-8">
   ...
   <div className="space-y-6">
    <Card className="rounded-2xl border border-border shadow-sm bg-white overflow-hidden border border-white/20">
    <CardHeader className="bg-primary/5 border-b border-border/10 px-8 py-6">
     ...
     <div className="flex gap-2">
      <Badge className="bg-blue-100 text-blue-700 border border-border font-black text-[10px] tracking-tight">ID: {selectedTeacherId.slice(0, 8)}</Badge>
     </div>
     </div>
    </CardHeader>
   ...
   <Card className="rounded-2xl border border-border shadow-sm bg-white overflow-hidden h-[500px] flex items-center justify-center border border-white/20">
    <div className="text-center space-y-6 px-12">
    <div className="mx-auto w-20 h-20 rounded-2xl bg-primary/10 flex items-center justify-center animate-bounce">
