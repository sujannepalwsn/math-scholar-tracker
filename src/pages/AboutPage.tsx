 ...
 return (
  <div className="min-h-screen bg-white text-slate-950 selection:bg-primary-light selection:text-primary">
   <Helmet>
    ...
    <meta name="description" content="Why we built EduFlow: to modernize education in Nepal through high-performance tools. Learn about our commitment to security and our vision for 2030." />
   </Helmet>
   ...
   <header className="fixed top-0 w-full z-[100] px-4 md:px-8 py-4 flex items-center justify-between border-b border-border bg-white transition-all">
    ...
    <nav className="hidden lg:flex items-center gap-10">
     ...
     <Link to="/about" className="text-sm font-bold text-primary transition-colors">About</Link>
    </nav>
   ...
   <main className="pt-40 pb-20 container mx-auto px-4">
    ...
    <section className="max-w-6xl mx-auto mb-40">
      <div className="grid md:grid-cols-2 gap-20 items-center">
       <div>
         ...
         <h1 className="text-6xl md:text-8xl font-black tracking-tight mb-8 uppercase leading-[1.1] text-slate-950">Why we built <span className="text-primary">EduFlow.</span></h1>
         <div className="space-y-6 text-xl text-slate-600 font-medium leading-relaxed">
          ...
          <p>
            We set out to build the "High-Performance School OS" — a platform that is as intuitive as it is powerful, designed to modernize the foundation of education in Nepal.
          </p>
         </div>
       </div>
       <div className="relative">
         <div className="aspect-square rounded-[3rem] bg-slate-50 border border-border relative overflow-hidden flex items-center justify-center group shadow-sm">
          ...
          <ShieldCheck className="h-48 w-48 text-primary/5 animate-pulse" />
          <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center">
            <p className="text-slate-950 font-black text-2xl uppercase tracking-widest leading-tight">Bridging the Gap</p>
            <p className="text-slate-400 font-bold uppercase text-[10px] tracking-[0.3em] mt-4">Traditional Schooling → Digital Future</p>
          </div>
         </div>
       </div>
      </div>
    ...
    <section className="py-32 bg-slate-50 border border-border rounded-[3rem] px-8 md:px-20 mb-40 relative overflow-hidden group">
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-primary/5 rounded-full blur-[120px] transition-all group-hover:bg-primary/10" />
      <div className="max-w-4xl mx-auto text-center mb-24">
       <Shield className="h-20 w-20 text-primary mx-auto mb-10" />
       <h2 className="text-4xl md:text-6xl font-black tracking-tight mb-8 uppercase leading-[1.1] text-slate-950">Security by Design.</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
       {[
        ...
        <div key={i} className="space-y-4">
          <div className="w-12 h-12 rounded-2xl bg-white border border-border shadow-sm flex items-center justify-center mx-auto text-primary group-hover:scale-110 transition-transform">
           <s.icon className="h-6 w-6" />
          </div>
          <h4 className="font-black text-slate-950 uppercase text-xs tracking-widest">{s.label}</h4>
    ...
    <section className="max-w-6xl mx-auto mb-40">
      <div className="grid md:grid-cols-3 gap-8">
       {[
        ...
        <div key={i} className="p-12 rounded-2xl bg-white border border-border shadow-sm text-center transition-all hover:border-primary/20 hover:shadow-md group">
          <p className="text-5xl font-black text-slate-950 tracking-tighter mb-4 group-hover:text-primary transition-colors">{stat.value}</p>
    ...
    <section className="text-center pb-40">
      <div className="max-w-4xl mx-auto">
       ...
       <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
         <Button asChild size="lg" className="h-20 px-16 rounded-2xl text-2xl font-black bg-primary hover:bg-primary/90 text-white shadow-2xl shadow-primary/40 transition-transform hover:scale-105 active:scale-95">
   ...
   <footer className="py-20 border-t border-border bg-slate-50 text-center">
     <div className="flex justify-center gap-12 mb-10">
      <TwitterIcon className="h-6 w-6 text-slate-400 hover:text-primary transition-colors cursor-pointer" />
      <LinkedInIcon className="h-6 w-6 text-slate-400 hover:text-primary transition-colors cursor-pointer" />
      <GithubIcon className="h-6 w-6 text-slate-400 hover:text-primary transition-colors cursor-pointer" />
     </div>
     <p className="text-slate-500 font-black uppercase tracking-widest text-[10px]">Secure Infrastructure • v3.4.0 (Enterprise)</p>
     <p className="mt-4 text-slate-400 font-bold uppercase tracking-widest text-[8px]">© {new Date().getFullYear()} EduFlow Tech Solutions. All rights reserved.</p>
   </footer>
  </div>
 );
};
