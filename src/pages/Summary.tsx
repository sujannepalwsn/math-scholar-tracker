  ...
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
   <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
    ...
    <div className="flex flex-wrap gap-3">
     <Button variant="outline" size="sm" onClick={exportToCSV} className="rounded-xl h-11 border-2 font-black uppercase text-[10px] tracking-widest px-6 shadow-sm hover:bg-white">
    ...
    <div className="flex flex-wrap gap-6 items-end">
     <div className="space-y-2">
      ...
      <Select value={gradeFilter} onValueChange={setGradeFilter}>
       <SelectTrigger className="w-[160px] h-11 bg-slate-50 border-border focus:ring-primary/20 rounded-xl">
     ...
     <div className="space-y-2">
      ...
      <input
       ...
       className="flex h-11 w-[180px] rounded-xl border border-border bg-slate-50 px-4 py-2 text-sm transition-all focus:ring-2 focus:ring-primary/20 focus:border-primary/50 shadow-sm outline-none"
      />
     </div>
    </div>
   </Card>
        ...
        <TableBody>
         {summaryData.map((student) => (
          <TableRow key={student.id} className="group transition-all duration-300">
           ...
           <TableCell>
            <Badge variant="secondary" className="bg-primary/10 text-primary border border-border rounded-lg font-bold">
             {student.grade}
            </Badge>
           </TableCell>
           ...
           <TableCell className="text-center">
            <Badge
             ...
             className={cn(
              ...
              student.percentage >= 75 ? "bg-green-500/20 text-green-700 hover:bg-green-500/30 border border-border" : "shadow-sm"
             )}
            >
             {student.percentage}%
            </Badge>
