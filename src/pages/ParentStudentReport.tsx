    ...
    {selectedStudentId !== "none" && (
     <div className="space-y-2">
      ...
      <Select value={selectedPublishedExamId} onValueChange={setSelectedPublishedExamId}>
       <SelectTrigger className="w-[200px] h-11 bg-white border-muted-foreground/10 focus:ring-primary/20 rounded-xl">
   ...
   {isLoading ? (
    ...
    <div className="space-y-8">
     ...
     {selectedPublishedExamId !== "none" && studentExams.find(e => e.id === selectedPublishedExamId) && (
      <Card className="border border-border shadow-sm overflow-hidden rounded-2xl animate-in fade-in slide-in-from-top-4 duration-500">
     ...
     {/* Finance Summary */}
     <Card id="finance-section" className="border border-border shadow-sm overflow-hidden rounded-2xl">
     ...
     {/* Attendance Overview */}
     <Card id="attendance-section" className="border border-border shadow-sm overflow-hidden rounded-2xl">
     ...
     <Card id="milestones-section" className="border border-border shadow-sm overflow-hidden rounded-2xl">
     ...
     <Card id="published-results-section" className="border border-border shadow-sm overflow-hidden rounded-2xl bg-white ">
      <CardHeader className="bg-primary/5 pb-4 border-b border-primary/10">
