...
const InitAdmin = () => {
 ...
 return (
  <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden p-4">
   ...
   <Card className="w-full max-w-md border border-border shadow-sm bg-white animate-in zoom-in-95 duration-500">
    <CardHeader className="space-y-4 pt-8">
     <div className="mx-auto bg-primary/10 p-4 rounded-2xl w-fit shadow-sm">
