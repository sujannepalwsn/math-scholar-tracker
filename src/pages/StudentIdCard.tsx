...
export default function StudentIdCard() {
 ...
 return (
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
   ...
   <Card className="no-print rounded-2xl border border-border shadow-sm p-6 bg-white border border-white/20">
     ...
     <CardContent className="p-6 flex flex-col sm:flex-row gap-6">
      <div className="relative flex-1">
       ...
       <div className="relative mt-2">
        ...
        <Input placeholder="Name or Student ID..." className="pl-9 h-11 bg-white border-muted-foreground/10 focus:ring-primary/20 rounded-xl" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
       </div>
      </div>
      <div className="w-full sm:w-[200px]">
       ...
       <Select value={gradeFilter} onValueChange={setGradeFilter}>
        <SelectTrigger className="h-11 bg-white border-muted-foreground/10 focus:ring-primary/20 rounded-xl mt-2">
