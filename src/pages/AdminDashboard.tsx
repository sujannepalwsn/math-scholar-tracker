...
const AdminDashboard = () => {
 ...
 return (
  <div className="space-y-12 animate-in fade-in duration-1000">
   ...
   <Card className="border border-border shadow-sm rounded-2xl bg-slate-900 text-white overflow-hidden">
    <CardContent className="p-12">
     <div className="max-w-2xl space-y-6">
      ...
      <div className="flex gap-4 pt-4">
       <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-white/5">
