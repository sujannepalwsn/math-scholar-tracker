  ...
  <div className="min-h-screen bg-background p-4 md:p-8 space-y-8 pb-24 md:pb-8 page-enter animate-in fade-in duration-1000">
   ...
   <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
    <div className="relative group/search flex-1 max-w-md hidden md:block">
     ...
     <Input placeholder="Search classes, students, lesson plans..." className="pl-10 h-11 rounded-2xl bg-white border-white/40 shadow-sm cursor-pointer " readOnly onClick={() => window.dispatchEvent(new CustomEvent('open-command-center'))} />
     <div className="absolute right-3 top-1/2 -translate-y-1/2 hidden lg:flex items-center gap-1 px-1.5 py-0.5 rounded-lg border bg-white text-[10px] font-black text-slate-400"><kbd>⌘</kbd> K</div>
    </div>
   ...
   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    <Card className="border border-border shadow-sm bg-white rounded-2xl overflow-hidden">
      <CardHeader className="bg-primary-light/30 border-b border-primary-light/50">
    ...
    <Card className="lg:col-span-2 border border-border shadow-sm bg-white rounded-2xl">
      <CardHeader className="border-b border-slate-50 bg-slate-50/30"><CardTitle className="text-lg font-bold">Upcoming Professional Milestones</CardTitle></CardHeader>
      <CardContent>
