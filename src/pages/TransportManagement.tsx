   ...
   <Tabs defaultValue="tracking" className="space-y-8">
    ...
    <TabsContent value="tracking" className="outline-none">
     <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
       <Card className="lg:col-span-8 rounded-2xl border border-border shadow-sm bg-slate-900 overflow-hidden relative min-h-[600px]">
       ...
       <div className="lg:col-span-4 space-y-6">
             ...
             {[
              ...
              <div key={idx} className="p-4 flex items-center justify-between hover:bg-slate-50 transition-colors">
               ...
               <div className="text-right">
                 <Badge className={`bg-${v.color}-500 text-white border border-border text-[8px] font-black`}>{v.status}</Badge>
        ...
        <Button className="w-full h-12 rounded-2xl bg-slate-900 text-white font-black uppercase text-[10px] tracking-widest shadow-sm">Broadcast to Drivers</Button>
       </div>
     </div>
    </TabsContent>
