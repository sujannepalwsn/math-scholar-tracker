...
export default function TeacherMessaging() {
 ...
 return (
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
   ...
   <Card className="h-[700px] flex flex-col border border-border shadow-sm overflow-hidden rounded-2xl bg-white border border-border/20">
    <CardHeader className="bg-gradient-to-r from-primary to-violet-600 text-primary-foreground py-6 shadow-sm relative z-10 border-b border-border/10">
