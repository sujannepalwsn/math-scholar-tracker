...
export default function ParentDiscipline() {
 ...
 <div className="space-y-8 animate-in fade-in duration-1000">
  ...
  <Card className="md:col-span-2 border border-border shadow-sm overflow-hidden rounded-2xl bg-white border border-border/20">
   ...
   {isLoading ? (
    ...
    <Table>
     ...
     {issues.map((issue: any) => (
      <TableRow key={issue.id} className="group transition-all duration-300 hover:bg-white">
      ...
      <TableCell className="px-6 py-4">
       <Badge variant="outline" className={cn("rounded-lg border border-border text-[9px] font-black uppercase tracking-tighter px-2", getSeverityStyles(issue.severity))}>
       {issue.severity}
       </Badge>
      </TableCell>
  ...
  <div className="space-y-6">
   <Card className="border border-border shadow-sm rounded-2xl bg-gradient-to-br from-primary to-violet-700 text-white overflow-hidden">
   <CardContent className="p-6">
    <div className="flex items-center justify-between mb-4">
    <div className="p-2 rounded-xl bg-white ">
     <ShieldCheck className="h-6 w-6" />
    </div>
    <Badge className="bg-white text-white border border-border text-[10px] font-black">SYSTEM SECURE</Badge>
    </div>
