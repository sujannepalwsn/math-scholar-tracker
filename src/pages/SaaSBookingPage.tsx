    ...
    <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="space-y-2">
             ...
             <Input
              ...
              className="h-12 rounded-2xl bg-slate-50 border border-border shadow-inner"
             />
            </div>
            <div className="space-y-2">
          ...
          <AnimatePresence mode="wait">
            {selectedMethod && (
             <motion.div
               ...
               exit={{ opacity: 0, y: -10 }}
               className="p-8 rounded-2xl bg-slate-900 text-white space-y-6"
             >
               {selectedMethod === 'bank' && (
                <div className="space-y-4">
                 ...
                 <div className="p-5 rounded-2xl bg-white border border-white/10">
               ...
               {(selectedMethod === 'esewa' || selectedMethod === 'khalti') && (
                <div className="flex flex-col md:flex-row gap-8 items-center">
                 <div className="shrink-0 space-y-4 text-center">
                   ...
                   <div className="w-48 h-48 bg-white rounded-2xl p-3 shadow-2xl flex items-center justify-center overflow-hidden">
               ...
               {selectedMethod === 'card' && (
                <div className="text-center py-6 space-y-4">
                 <div className="p-4 rounded-full bg-white w-fit mx-auto"><CreditCard className="h-8 w-8 text-indigo-400" /></div>
               ...
               <div className="pt-6 border-t border-white/10 space-y-4">
                ...
                <div className="relative group">
                  ...
                  <label
                   ...
                   className="flex items-center justify-between p-4 rounded-2xl bg-white border-2 border-dashed border-white/20 hover:border-indigo-500 cursor-pointer transition-all"
                  >
      ...
      <div className="lg:col-span-1">
       <div className="sticky top-28 space-y-6">
         <Card className="rounded-2xl border border-border shadow-sm overflow-hidden bg-white">
         ...
         <div className="p-6 rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center text-center gap-3">
