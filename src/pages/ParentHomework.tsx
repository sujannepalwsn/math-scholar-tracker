...
export default function ParentHomework() {
 ...
 <Table>
     ...
     <TableBody>
      {data.map((hs: any) => (
       <TableRow key={hs.id} className="group transition-all duration-300 hover:bg-white">
        ...
        <TableCell className="px-6 py-4">
         <Badge variant="outline" className={cn("rounded-lg border border-border text-[9px] font-black uppercase tracking-tighter", getStatusStyles(hs.status))}>
          {hs.status.replace('_', ' ')}
         </Badge>
        </TableCell>
        ...
        <TableCell className="px-6 py-4 text-right">
         ...
         {hs.homework?.attachment_url && (
          <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-white shadow-sm" asChild title="Download Assignment">
         ...
         {hs.submission_url && (
          <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-white shadow-sm" asChild title="View My Submission">
 ...
 return (
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
   ...
   <Tabs defaultValue="today" className="w-full">
    <TabsList className="flex flex-nowrap w-full overflow-x-auto h-auto md:h-14 bg-white rounded-2xl md:rounded-2xl p-1.5 border border-border/40 shadow-sm gap-1 custom-scrollbar">
     <TabsTrigger value="today" className="rounded-xl md:rounded-[1.5rem] flex-1 min-w-[80px] data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm font-black uppercase text-[9px] md:text-[10px] tracking-widest py-2 md:py-0">Today</TabsTrigger>
     <TabsTrigger value="upcoming" className="rounded-xl md:rounded-[1.5rem] flex-1 min-w-[80px] data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm font-black uppercase text-[9px] md:text-[10px] tracking-widest py-2 md:py-0">Upcoming</TabsTrigger>
     <TabsTrigger value="completed" className="rounded-xl md:rounded-[1.5rem] flex-1 min-w-[80px] data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm font-black uppercase text-[9px] md:text-[10px] tracking-widest py-2 md:py-0">Settled</TabsTrigger>
     <TabsTrigger value="overdue" className="rounded-xl md:rounded-[1.5rem] flex-1 min-w-[80px] data-[state=active]:bg-rose-600 data-[state=active]:text-white data-[state=active]:shadow-sm font-black uppercase text-[9px] md:text-[10px] tracking-widest py-2 md:py-0">Breached</TabsTrigger>
    </TabsList>
