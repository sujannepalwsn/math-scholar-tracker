  ...
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
   <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
    ...
    <div className="flex flex-wrap gap-3 items-center">
     <Button onClick={() => navigate("/lesson-plans")} size="sm" className="rounded-xl h-10 px-4 font-bold shadow-sm transition-all gap-2">
   ...
   <Card className="border border-border shadow-sm rounded-2xl bg-white border border-border/20">
      ...
      <div className="flex flex-wrap gap-4 items-center">
       <div className="flex-1 min-w-[150px]">
        ...
        <Select value={statusFilter} onValueChange={setStatusFilter}>
         <SelectTrigger className="rounded-xl border border-border bg-muted/30">
          <SelectValue />
         </SelectTrigger>
         <SelectContent>
   ...
   <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
    <DialogContent className="w-[95vw] sm:max-w-4xl max-h-[90vh] overflow-y-auto rounded-2xl p-0 sm:p-6">
      ...
      <div className="space-y-8 p-6 pt-4 sm:p-0">
        ...
        {viewingLessonPlan.status === 'pending' && (
         <>
          ...
          <div className="p-8 rounded-2xl bg-slate-900 text-white shadow-sm space-y-6">
            <div className="space-y-2">
              ...
              <Textarea
               ...
               className="bg-white border-white/20 text-white placeholder:text-white/30 rounded-2xl h-24"
              />
            </div>
          ...
          <div className="p-6 rounded-2xl border-2 border-dashed bg-amber-50/50 border-amber-100">
        ...
        {(viewingLessonPlan.status === 'approved' || viewingLessonPlan.status === 'rejected') && (
         <div className={cn("p-6 rounded-2xl border-2 border-dashed",
