 ...
 return (
  <div className="space-y-8 animate-in fade-in duration-1000">
   ...
   <div className="relative group">
    ...
    <Card className="relative border border-border shadow-sm overflow-hidden bg-white border border-white/30 rounded-2xl">
     <CardContent className="p-6">
      ...
      <div className="flex-1 min-w-[150px]">
       ...
       <Select value={filterSubject} onValueChange={setFilterSubject}>
        <SelectTrigger className="h-11 bg-white border-muted-foreground/10 focus:ring-primary/20 rounded-xl">
         <SelectValue />
        </SelectTrigger>
        <SelectContent>
      ...
      <Table>
       ...
       <TableBody>
        {groupedLessonRecords.map((group) => (
         <React.Fragment key={group.lessonPlan.id}>
          <TableRow className="group border-muted/5 hover:bg-primary/5 transition-colors cursor-pointer" onClick={() => toggleShowStudents(group.lessonPlan.id)}>
           ...
           <TableCell>
            <Badge variant="secondary" className="bg-primary/10 text-primary border border-border rounded-lg px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider">
           ...
           <TableCell className="text-right pr-6">
             <div className="flex justify-end gap-2" onClick={e => e.stopPropagation()}>
              <Button
               variant="ghost"
               size="icon"
               className="h-8 w-8 rounded-xl bg-white shadow-sm text-primary hover:bg-primary/10"
               onClick={() => {
              ...
              <Button
               ...
               size="icon"
               className={cn(
                "h-8 w-8 rounded-xl bg-white shadow-sm transition-all",
        ...
        {showStudentsMap[group.lessonPlan.id] && (
         <TableRow className="bg-muted/5 border border-border hover:bg-muted/5">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
              <div className="space-y-2">
                ...
                <Select value={bulkRating.toString()} onValueChange={(v) => setBulkRating(parseInt(v))}>
                 <SelectTrigger className="bg-white rounded-xl h-10 shadow-sm border border-border"><SelectValue /></SelectTrigger>
                 <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Input
                 ...
                 className="bg-white rounded-xl h-10 shadow-sm border border-border"
                />
              </div>
              <Button
          ...
          <div className="overflow-x-auto border border-border/40 rounded-2xl bg-white ">
           <Table>
            <TableHeader>
             <TableRow className="hover:bg-transparent border-muted/10">
            ...
            <TableBody>
             {group.students.map((record) => (
              <TableRow key={record.id} className="group/row border-muted/5 hover:bg-white transition-colors">
               <TableCell className="text-center">
                 <Checkbox
               ...
               <TableCell>
                <div className="space-y-1.5 min-w-[200px]">
                 {record.evaluation_rating && (
                  <Badge className="bg-yellow-500/10 text-yellow-700 border border-border rounded-lg px-2 py-0.5 text-[9px] font-black">
                 ...
                 {canEdit && (
                  <>
                   ...
                   <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 rounded-xl bg-white shadow-sm text-destructive hover:bg-destructive/10"
