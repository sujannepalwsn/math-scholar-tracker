   ...
   <div className="p-4 md:p-8 space-y-6 max-w-lg mx-auto">
    ...
    {aiForecast && (
     <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
      <Card className="border border-border shadow-sm bg-gradient-to-br from-indigo-600 to-violet-700 text-white rounded-2xl overflow-hidden">
    ...
    <div className="grid grid-cols-2 gap-4">
     <Card className="border border-border shadow-sm rounded-2xl bg-white p-5 flex flex-col items-center justify-center text-center space-y-2">
     ...
     <Card className="border border-border shadow-sm rounded-2xl bg-white p-5 flex flex-col items-center justify-center text-center space-y-2" onClick={() => navigate('/parent-homework')}>
    ...
    <button
     ...
     className="w-full py-4 bg-white border-2 border-slate-100 rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] text-slate-400 hover:bg-slate-50 transition-all shadow-sm"
    >
     View Full Dashboard
    </button>
   </div>
