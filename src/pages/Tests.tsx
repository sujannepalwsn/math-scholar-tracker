...
export default function Tests() {
       ...
       <TableBody>
        {testsWithFiles.map((test) => (
         <TableRow key={test.id} className="group border-muted/5 hover:bg-primary/5 transition-colors">
          ...
          <TableCell>
           <Badge className="text-[10px] bg-primary/10 text-primary border border-border font-bold">
    ...
    <div className="flex flex-wrap gap-3">
     ...
     <Dialog open={isAddingTest} onOpenChange={setIsAddingTest}>
      <DialogTrigger asChild>
       {canEdit && (
        <Button className="rounded-xl shadow-sm font-black uppercase text-[10px] tracking-widest h-11 px-6">
 ...
 <Table>
        ...
        {tests.map((test) => (
         ...
         >
          ...
          <TableCell className="text-center">
           <Badge className="bg-primary/10 text-primary border border-border font-black text-[10px]">
    ...
    {selectedTest && selectedTestData && (
     <Card className="border border-border shadow-sm overflow-hidden rounded-2xl animate-in slide-in-from-right-4 duration-500">
