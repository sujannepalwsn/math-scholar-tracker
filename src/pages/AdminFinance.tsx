  ...
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
   <div className="max-w-7xl mx-auto space-y-12">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <Card className="lg:col-span-2 border border-border shadow-sm rounded-2xl bg-white border border-border/20 p-8">
      ...
      <Card className="border border-border shadow-sm rounded-2xl bg-white border border-border/20 p-8 flex flex-col justify-between">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 hidden">
     ...
     <Card className="border border-border shadow-sm rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 text-white p-8 flex flex-col justify-between">
    ...
    {overdueCount > 0 && (
     <div className="flex items-center gap-4 p-6 bg-red-50/50 border border-red-100 rounded-2xl text-red-700 shadow-sm animate-in slide-in-from-top-2 mb-12">
    ...
    <Tabs value={activeTab} onValueChange={(val) => setSearchParams({ tab: val })} className="space-y-8">
     <TabsList className="flex flex-nowrap w-full overflow-x-auto h-14 bg-white rounded-2xl p-1.5 border border-border/40 shadow-sm custom-scrollbar">
      <TabsTrigger value="invoices" className="rounded-[1.5rem] flex-1 min-w-[100px] data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm font-black uppercase text-[10px] tracking-widest">Invoices</TabsTrigger>
      <TabsTrigger value="fees" className="rounded-[1.5rem] flex-1 min-w-[100px] data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm font-black uppercase text-[10px] tracking-widest">Fees</TabsTrigger>
      <TabsTrigger value="payments" className="rounded-[1.5rem] flex-1 min-w-[100px] data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm font-black uppercase text-[10px] tracking-widest">Payments</TabsTrigger>
      <TabsTrigger value="expenses" className="rounded-[1.5rem] flex-1 min-w-[100px] data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm font-black uppercase text-[10px] tracking-widest">Expenses</TabsTrigger>
      <TabsTrigger value="reports" className="rounded-[1.5rem] flex-1 min-w-[100px] data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm font-black uppercase text-[10px] tracking-widest">Analytics</TabsTrigger>
      <TabsTrigger value="settings" className="rounded-[1.5rem] flex-1 min-w-[100px] data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm font-black uppercase text-[10px] tracking-widest">Settings</TabsTrigger>
     </TabsList>
