            ...
            <div className="flex justify-end gap-2">
             {activity.activities?.photo_url && (
               <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 rounded-xl bg-white shadow-sm text-primary"
                onClick={() => {
             ...
             {hasActionPermission(user, 'preschool_activities', 'edit') && (
              <>
               <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-white shadow-sm text-primary hover:bg-primary/10" onClick={() => handleEditClick(activity)}>
                <Edit className="h-4 w-4" />
               </Button>
               <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-white shadow-sm text-destructive hover:bg-destructive/10" onClick={() => deleteActivityMutation.mutate(activity.id)}>
