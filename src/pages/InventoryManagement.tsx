  ...
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
   ...
   <Tabs defaultValue="assets" className="space-y-8">
    <TabsList className="flex flex-nowrap overflow-x-auto w-full bg-white border border-slate-100 p-1 rounded-2xl h-14 shadow-sm ">
     <TabsTrigger value="assets" className="rounded-xl px-8 font-black uppercase text-[10px] tracking-widest data-[state=active]:shadow-sm">Fixed Assets</TabsTrigger>
     <TabsTrigger value="library" className="rounded-xl px-8 font-black uppercase text-[10px] tracking-widest data-[state=active]:shadow-sm">Library Catalog</TabsTrigger>
     <TabsTrigger value="stock" className="rounded-xl px-8 font-black uppercase text-[10px] tracking-widest data-[state=active]:shadow-sm">Consumables</TabsTrigger>
    </TabsList>
