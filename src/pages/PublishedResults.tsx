 ...
 return (
  <div className="space-y-8 animate-in fade-in duration-1000 page-enter">
     ...
     <div className="flex flex-wrap gap-6 items-end">
      <div className="space-y-2">
       ...
       <div className="flex gap-2">
        <Input
         type="date"
         className="w-[150px] h-11 bg-white border-muted-foreground/10 focus:ring-primary/20 rounded-xl font-bold"
      ...
      <div className="space-y-2">
       ...
       <Select value={selectedExamId} onValueChange={setSelectedExamId}>
        <SelectTrigger className="w-[250px] h-11 bg-white border-muted-foreground/10 focus:ring-primary/20 rounded-xl font-bold">
      ...
      {user?.role !== UserRole.PARENT && (
       <div className="space-y-2">
        ...
        <Select value={gradeFilter} onValueChange={setGradeFilter}>
         <SelectTrigger className="w-[150px] h-11 bg-white border-muted-foreground/10 focus:ring-primary/20 rounded-xl font-bold">
      ...
      <div className="flex-1 min-w-[200px] space-y-2">
       ...
       <div className="relative">
        ...
        <Input
         ...
         className="pl-9 h-11 bg-white border-muted-foreground/10 focus:ring-primary/20 rounded-xl font-bold"
         value={searchQuery}
      ...
      {selectedExamId && (
       <Button
        variant="outline"
        className="h-11 rounded-xl border-2 font-bold px-6 shadow-sm bg-white"
   ...
   {selectedExamId ? (
         ...
         {studentResults.map((result) => (
          <TableRow key={result.student.id} className="group border-muted/5 hover:bg-primary/5 transition-colors">
           ...
           <TableCell className="text-center">
            {result.hasAnyMarks ? (
             <Badge className="bg-primary/10 text-primary border border-border rounded-lg px-2 py-0.5 text-[10px] font-black">{getGradeFormal(result.percentage)}</Badge>
            ) : "-"}
           </TableCell>
           <TableCell className="text-center">
            {result.hasAnyMarks ? (
             <Badge variant={result.allPassed ? "success" : "destructive"} className="font-black uppercase text-[10px] border border-border shadow-sm">
           ...
           <TableCell className="text-right pr-6">
            <Button
             variant="ghost"
             size="icon"
             className="h-8 w-8 rounded-xl bg-white shadow-sm text-primary hover:bg-primary/10 group-hover:scale-110 transition-all"
    ...
    <div className="p-20 text-center flex flex-col items-center gap-4 bg-muted/20 rounded-2xl border-2 border-dashed">
